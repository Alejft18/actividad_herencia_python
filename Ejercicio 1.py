...
class Empleado(Persona):
    ...
    def pagar_impuestos(self):
        if self.sueldo > 3600000:
            ...
            sueldofin= self.sueldo-descuento
            print("Tienes un descuento del 3,5%")
            print("Tu descuento es de ", descuento)
            print("El empleado debe pagar",sueldofin)
        else:
            print("El empleado no Tiene desceunto")
            print("El empleado debe pagar", self.sueldo)
